        ...
        <div className={boxClasses}>
          <div className="md:flex">
            ...
            <div className="p-8 w-full">
              ...
              <p className={dateTextClasses}><span className="text-white dark:text-cstmpurple">Middelburg, NL</span> (2021-2025)</p>
        ...
        <div className={boxClasses}>
          <div className="md:flex">
            ...
            <div className="p-8 w-full">
              ...
              <p className={dateTextClasses}><span className="text-white dark:text-cstmpurple">Utrecht, NL</span> (Sep 2024 - Jan 2025)</p>
        ...
        <div className={boxClasses}>
          <div className="md:flex">
            ...
            <div className="p-8 w-full">
              ...
              <p className={dateTextClasses}><span className="text-white dark:text-cstmpurple">Calgary, CA</span> (Jan 2025 - May 2025)</p>
